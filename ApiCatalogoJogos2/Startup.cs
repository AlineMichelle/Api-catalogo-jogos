...
using ApiCatalogoJogos2.Controllers;
...
namespace ApiCatalogoJogos2
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IJogosRepository, JogoRepository>();
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "ApiCatalogoJogos2", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiCatalogoJogos2 v1"));
            }
